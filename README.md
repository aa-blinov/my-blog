...
- Посты блога: `src/content/blog/*.md`
- Страницы: `src/pages/` (index, about-me, blog, blog/[section], blog/[section]/[slug])

## Как добавить новую статью

1. Создай новый Markdown файл в папке `src/content/blog/`, например `my-new-post.md`.
2. В начале файла добавь **frontmatter** (метаданные) между тремя дефисами `---`.
3. Обязательные поля: `title`, `date`, `section`.
4. Опциональные поля: `summary` (краткое описание), `draft` (true/false, по умолчанию false).

**Пример новой статьи (`src/content/blog/my-new-post.md`):**
...
date: 2026-03-08
draft: false
summary: "Краткое описание о чем эта статья, которое будет видно в списке."
section: dev
---

Здесь начинается текст самой статьи в формате Markdown.
```
