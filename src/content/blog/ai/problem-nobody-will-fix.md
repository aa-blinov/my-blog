...
Отрасль это уже проговорила вслух. В [свежем OWASP Top 10 для LLM-приложений](https://genai.owasp.org/resource/owasp-genai-llm-top-10-2026/) избыточные полномочия агента поднялись с шестого места на третье. Разговор сместился с того, что модель отвечает, на то, до чего она дотягивается.
